  ...
  <body>
    ...
    <div class="jumbotron">
      <h1><i class="glyphicon glyphicon-edit"></i> Edit Data </h1>
      <p></p> 
  ...
  ?>
      <form method="POST" >
          <div class="form-group" id="myForm">
            <label>Name:</label>
            <input type="textl" value=" <?php echo $names; ?>" class="form-control" name="names" >
          </div>
          <div class="form-group">
            <label >Work:</label>
            <select class="form-control"name="id_work" value="<?php echo $id_work ?>">
        ...
        <div>
          ...
          <a href="index.php"> <input type="button" class="btn btn-primary" name="Kembali" value="Home" > </a> <nbr>
        </div>    
